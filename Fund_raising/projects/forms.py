...
from .models import Project_data , Category,Project_pics,project_comments,Donate_project,Report_project,project_tags
...
class Project_Data(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('title', 'details','category','target','end_date','current_money','user','img','tags')
